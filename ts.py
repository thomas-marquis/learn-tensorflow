...
california_housing_dataframe = pd.read_csv(dataset_url, sep=",")
...
#%% stats descriptives à l'arrache
...
#%% configuration du model et du gradiant
...
predictions_generator = linear_regressor.predict(
    input_fn=prediction_input_fn)

# Format predictions as a NumPy array, so we can calculate error metrics.
predictions = np.array(
    [item["predictions"][0] for item in predictions_generator])
...
#%% Interprétation de l'erreur du modele
